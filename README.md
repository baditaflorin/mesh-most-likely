...
[![pages](https://img.shields.io/badge/live-baditaflorin.github.io%2Fmesh-most-likely-e0567c)](https://baditaflorin.github.io/mesh-most-likely/)
[![version](https://img.shields.io/badge/version-0.1.0-blue)](https://github.com/baditaflorin/mesh-most-likely/blob/main/package.json)
[![license](https://img.shields.io/badge/license-MIT-green)](./LICENSE)

> Most-likely-to / never-have-I-ever / would-you-rather party decks with live mesh voting

**Live → https://baditaflorin.github.io/mesh-most-likely/**

**Source → https://github.com/baditaflorin/mesh-most-likely**
...
git clone https://github.com/baditaflorin/mesh-most-likely
cd mesh-most-likely
npm install
npm run dev
```
...
- `mesh-most-likely:signalingUrl`
- `mesh-most-likely:turnTokenUrl`
- `mesh-most-likely:iceServers`
- `mesh-most-likely:room`
